...
const variantClasses = (variant) => ({
    ...
    'bg-white text-gray-500 hover:bg-gray-300 focus:ring-purple-500 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200':
        variant == 'secondary',
